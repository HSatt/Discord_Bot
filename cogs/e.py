...
class E(commands.Cog):
    ...
    async def amogus(self, ctx: Context) -> None:
        ...
        await embed(ctx, title='Play Among us now!', description='''"Among Us" is a multiplayer online game where players work together on a spaceship to complete tasks, 
